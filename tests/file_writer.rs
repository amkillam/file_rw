...
#[test]
fn test_overwrite() {
    file_writer_test!("test_overwrite", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, file_reader| {
        assert_eq!(file_reader.read_to_string(), "Hello, world!");
    });
}
...
#[test]
fn extend_len_by() {
    file_writer_test!("test_extend_len_by", "", |tempdir, tempdir_path, test_file_path, file_writer, _file_reader| {
...
#[test]
fn test_set_len() {
    file_writer_test!("test_set_len", "", |tempdir, tempdir_path, test_file_path, file_writer, _file_reader| {
...
#[test]
fn test_len() {
    file_writer_test!("test_len", "", |tempdir, tempdir_path, test_file_path, file_writer, _file_reader| {
        file_writer.set_len(100);
        assert!(file_writer.len() == 100);
    });
}
...
#[test]
fn test_append() {
    file_writer_test!("test_append", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, _file_reader| {
...
#[test]
fn test_open() {
    file_writer_test!("test_open", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, file_reader| {
        assert_eq!(file_reader.read_to_string(), "Hello, world!");
    });
}
...
#[test]
fn test_write() {
    file_writer_test!("test_write", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, file_reader| {
...
#[test]
fn test_replace() {
    file_writer_test!("test_replace", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, file_reader| {
...
file_writer_test!("test_find_replace", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, file_reader| {
...
fn test_find_replace_nth() {
    file_writer_test!("test_find_replace_nth", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, file_reader| {
        for_each_preprocessor!(file_writer, |preprocessor| {
...
fn test_find_replace_all() {
    file_writer_test!("test_find_replace_all", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, file_reader| {
        for_each_preprocessor!(file_writer, |preprocessor| {
...
#[test]
fn test_file() {
    file_writer_test!("test_file", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, _file_reader| {
...
#[test]
fn test_path() {
    file_writer_test!("test_path", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, _file_reader| {
...
#[test]
fn test_mmap() {
    file_writer_test!("test_mmap", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, file_reader| {
...
#[test]
fn test_to_reader() {
    file_writer_test!("test_to_reader", "Hello, world!", |tempdir, tempdir_path, test_file_path, file_writer, _file_reader| {
